...
At this point we still have redundancies or unclear information due to the sliding window. To solve this problem a connectionist temporal classification (CTC) is used as originally developed by ~\cite{Graves:2006:CTC:1143844.1143891}. A detailed explanation would be outside of the scope of this paper and can be found here %ref.
